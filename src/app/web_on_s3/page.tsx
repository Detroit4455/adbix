                  ...
                  {mobileNumber && hasWebsiteFiles ? (
                    <div className="space-y-6">
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-lg">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="flex space-x-1">
                              ...
                              <div className="w-3 h-3 bg-green-400 rounded-full"></div>
                               ...
                               <div className="text-xs text-gray-500 bg-white rounded px-3 py-1 inline-block">
                        ...
                        {/* Preview Content */}
                        <div className="flex justify-center bg-gray-100 p-6" style={{ minHeight: '600px' }}>
                          <div 
                          ...
                          >
                            ...
                            {isMobileView && (
                              <div className="relative w-full h-full">
                                {/* Phone Body */}
                                <div className="w-full h-full bg-gray-900 rounded-[2.5rem] p-2 shadow-xl">
                                  {/* Screen Bezel */}
