    ...
    try {
      ...
      if (result?.error) {
        ...
        if (result.error.includes('No account found')) {
          setError('No account found with this mobile number. Please check your mobile number or create a new account.');
        } else if (result.error.includes('Incorrect password')) {
          setError('Incorrect password. Please check your password and try again.');
        } else if (result.error.includes('Please enter both')) {
