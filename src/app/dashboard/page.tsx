...
import ContactUsMessagesPanel from '@/components/ContactUsMessagesPanel';
...
export default function DashboardPage() {
  ...
  // All possible quick action cards
  const allQuickActions = [
    {
      ...
      requiresPermission: 'upload-website'
    },
    {
  ...
  const quickActions = allQuickActions.filter(action => {
    if (action.requiresPermission === 'upload-website') {
      ...
      <div className="flex-1 ml-0 lg:ml-64 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
            {/* Contact-Us Widget Messages */}
            <div className="xl:col-span-3">
              <ContactUsMessagesPanel />
            </div>
